                        ...
                        <tbody>
                            <tr>
                                <td style="text-align: center; padding-bottom:25px">
                                    <h2 style="font-size: 30px; color: #5d6ee2; font-weight: 600; margin: 0;">Baked by Phill</h2>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            <tr>
                                <td style="padding: 30px 30px 15px 30px;">
                                    <h2 style="font-size: 18px; color: #6576ff; font-weight: 600; margin: 0;">%name%, thank you for your order</h2>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="padding: 20px 30px 40px">
                                    <p>If you did not register, please contact us or ignore this message.</p>
                        ...
                        <tbody>
                            <tr>
                                <td style="text-align: center; padding:25px 20px 0;">
                                    <p style="font-size: 13px;">Copyright © <?php echo date('Y'); ?> KynosLab. All rights reserved.</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
